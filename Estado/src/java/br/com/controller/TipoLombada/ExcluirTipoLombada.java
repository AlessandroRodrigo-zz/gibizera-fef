 ...
 * @author Aluno
 */
@WebServlet(name = "ExcluirTipoLombada", urlPatterns = {"/ExcluirTipoLombada"})
public class ExcluirTipoLombada extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            daoTipoLombada.Excluir(cTipoLombada);
            request.getRequestDispatcher("ListarTipoLombada").forward(request, response);
        } catch (Exception ex) {
            System.out.println("Problemas ao excluir TipoLombada! Erro: " + ex.getMessage());
            ex.printStackTrace();
        }
    }

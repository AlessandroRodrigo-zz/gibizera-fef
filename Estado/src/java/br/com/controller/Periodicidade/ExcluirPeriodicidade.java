 ...
 * @author Aluno
 */
@WebServlet(name = "ExcluirPeriodicidade", urlPatterns = {"/ExcluirPeriodicidade"})
public class ExcluirPeriodicidade extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String Situacao = request.getParameter("situacaoPeriodicidade");
        ...
        try {
            ...
            daoPeriodicidade.Excluir(cPeriodicidade);
            request.getRequestDispatcher("ListarPeriodicidade").forward(request, response);
        } catch (Exception ex) {
            System.out.println("Problemas ao excluir Periodicidade! Erro: " + ex.getMessage());
            ex.printStackTrace();
        }
    }

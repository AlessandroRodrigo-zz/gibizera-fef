 ...
 * @author Aluno
 */
@WebServlet(name = "ExcluirLicenciadora", urlPatterns = {"/ExcluirLicenciadora"})
public class ExcluirLicenciadora extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String Situacao = request.getParameter("situacaoLicenciadora");
        Licenciadora cLicenciadora = new Licenciadora();
        
        cLicenciadora.setIdLicenciadora(idLicenciadora);
        cLicenciadora.setSituacaoLicenciadora(Situacao);
        
        try {
            GenericDAO daoLicenciadora = new LicenciadoraDAO();
            daoLicenciadora.Excluir(cLicenciadora);
            request.getRequestDispatcher("ListarLicenciadora").forward(request, response);
        } catch (Exception ex) {
            System.out.println("Problemas ao excluir Licenciadora! Erro: " + ex.getMessage());
            ex.printStackTrace();
        }
    }

 ...
 * @author Aluno
 */
@WebServlet(name = "ExcluirPersonagem", urlPatterns = {"/ExcluirPersonagem"})
public class ExcluirPersonagem extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String Situacao = request.getParameter("situacaoPersonagem");
        ...
        try {
            ...
            daoPersonagem.Excluir(cPersonagem);
            request.getRequestDispatcher("ListarPersonagem").forward(request, response);
        } catch (Exception ex) {
            System.out.println("Problemas ao excluir Personagem! Erro: " + ex.getMessage());
            ex.printStackTrace();
        }
    }

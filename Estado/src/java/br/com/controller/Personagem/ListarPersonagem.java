 ...
 * @author Aluno
 */
@WebServlet(name = "ListarPersonagem", urlPatterns = {"/ListarPersonagem"})
public class ListarPersonagem extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            ...
            request.setAttribute("Personagems", daoPersonagem.Listar());
            request.getRequestDispatcher("Cadastros/Personagem/ListarPersonagem.jsp").forward(request, response);

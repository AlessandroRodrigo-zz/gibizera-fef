 ...
 * @author Aluno
 */
@WebServlet(name = "ExcluirEditora", urlPatterns = {"/ExcluirEditora"})
public class ExcluirEditora extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        String Situacao = request.getParameter("situacaoEditora");
        Editora cEditora = new Editora();
        
        cEditora.setIdEditora(idEditora);
        cEditora.setSituacaoEditora(Situacao);
        
        try {
            GenericDAO daoEditora = new EditoraDAO();
            daoEditora.Excluir(cEditora);

 ...
 * @author Flavio Prado
 */
@WebServlet(name = "NovoComprador", urlPatterns = {"/NovoComprador"})
public class NovoComprador extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        try {
            //cria cidade vazia
            Comprador cComprador = Comprador.CompradorVazio();
            ...
            request.setAttribute("Comprador", cComprador);
            ...
            System.out.println("Problemas no Servlet ao Novo Comprador! Erro: " + ex.getMessage());
        }
    }

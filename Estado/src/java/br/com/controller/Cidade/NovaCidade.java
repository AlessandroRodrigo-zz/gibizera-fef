 ...
 * @author Aluno
 */
@WebServlet(name = "NovaCidade", urlPatterns = {"/NovaCidade"})
public class NovaCidade extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException, Exception {
        ...
        //Carrega classe Cidade
        Cidade cCidade = new Cidade();
        cCidade.setIdCidade(0);
        cCidade.setNomeCidade("");
        
        //Carrega classe estado
        Estado cEstado = new Estado();
        cCidade.setEstado(cEstado);        
        
        //Manda pra View
        request.setAttribute("cidade", cCidade);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(NovaCidade.class.getName()).log(Level.SEVERE, null, ex);
        }
    }

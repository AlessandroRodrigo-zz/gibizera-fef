...
<html>
    ...
    <center><a href="${pageContext.request.contextPath}/NovoGenero" class="btn">Voltar</a></center>
            ...
            <tbody>
                <c:forEach var="Genero" items="${Generos}">
                    <tr>
                        ...
                        <td>${Genero.situacaoGenero}</td>                                                                                                                 
                        <td><a href="${pageContext.request.contextPath}/ExcluirGenero?idGenero=${Genero.idGenero}&situacaoGenero=${Genero.situacaoGenero}">Excluir</a></td>

    ...
    <body class="align">
        <div class="grid">
            ...
            <div style="display: flex; flex: 1; justify-content: center; margin-top: 5vh;">
                <a href="cadastroUsuario.jsp" style="text-decoration: none; text-transform: none;">Ainda não possui uma conta? <span style="color: #A600D4; cursor: pointer;">Crie uma!</span></a>
            </div>
        </div>    
    </body>

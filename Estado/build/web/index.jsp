    ...
    <body class="align">
        <div class="grid">
            <form action="ValidarUsuario" action="${pageContext.request.contextPath}/ValidarUsuario" method="POST" class="form login">
                ...
                <div class="form__field">
                    <label for="login__username"><svg class="icon"><i class="far fa-user"></i></svg><span class="hidden">Usuário</span></label>
                    <input id="login__username" type="text" name="loginUsuario" class="form__input" placeholder="Usuário" required>
                </div>
                <div class="form__field">

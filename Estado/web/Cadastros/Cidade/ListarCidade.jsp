...
<html>
    ...
    <body>
        ...
        <br><br>
    <center><a href="${pageContext.request.contextPath}/NovaCidade" class="btn">Voltar</a></center>
            ...
            <tbody>
                <c:forEach var="Cidade" items="${Cidades}">
                    <tr>
                        ...
                        <td><a href="${pageContext.request.contextPath}/CarregarCidade?idEstado=${Cidade.estado.idEstado}&idCidade=${Cidade.idCidade}">Alterar</a></td>
                    </tr>
                </c:forEach>
            </tbody>
        </table>
